...
const createDev = (options) => async (app) => {
    ...
    const config = await (0, createDevConfig_1.createDevConfig)(app, options);
    const webpackConfig = (0, utils_2.resolveWebpackConfig)({
        config,
        options,
        isServer: false,
        isBuild: false,
    ...
    const serverConfig = await (0, createDevServerConfig_1.createDevServerConfig)(app, options);
