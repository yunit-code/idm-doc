...
const renderPage = async ({ app, page, vueApp, vueRouter, ssrTemplate, allFilesMeta, initialFilesMeta, asyncFilesMeta, moduleFilesMetaMap, }) => {
    ...
    const pageRendered = await (0, server_renderer_1.renderToString)(vueApp, ssrContext);
    // resolve client files that used by this page
    const pageClientFilesMeta = (0, resolvePageClientFilesMeta_1.resolvePageClientFilesMeta)({
    ...
    const html = ssrTemplate
        ...
        // page styles
        .replace('<!--vuepress-ssr-styles-->', (0, renderPageStyles_1.renderPageStyles)({ app, initialFilesMeta, pageClientFilesMeta }))
        .replace('<!--vuepress-ssr-app-->', pageRendered)
        // page scripts
        .replace('<!--vuepress-ssr-scripts-->', (0, renderPageScripts_1.renderPageScripts)({ app, initialFilesMeta, pageClientFilesMeta }));
    // write html file
